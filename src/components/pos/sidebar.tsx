...
import { ShoppingCart, LayoutDashboard, Package, ReceiptText, Boxes, Users as UsersIcon, Crown, Shield, UserCog, LogOut, Settings, Tags, BarChart3, ScrollText } from 'lucide-react'
import { hasEffectivePermission, type Role, type SessionUser } from '@/lib/auth-types'

export type ViewType = 'dashboard' | 'pos' | 'products' | 'categories' | 'orders' | 'inventory' | 'reports' | 'users' | 'audit' | 'settings'
...
const ALL_NAV_ITEMS: { id: ViewType; label: string; icon: React.ElementType; permission: 'viewDashboard' | 'viewPOS' | 'viewProducts' | 'viewOrders' | 'viewInventory' | 'viewUsers' | 'viewSettings' | 'viewReports' }[] = [
  ...
  { id: 'audit', label: 'Audit Log', icon: ScrollText, permission: 'viewUsers' },
